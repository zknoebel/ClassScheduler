...
public class EZweekSchedule {
	...
	EZweekSchedule(int x, int y) {
		...
		if (x == 15 * EZgui.x / 16) {
			EZ.addLine(EZgui.x / 8, (int) (EZgui.y * 75 / 1000), EZgui.x, (int) (EZgui.y * 75 / 1000), Color.black,
					(int) (EZgui.y * 5 / 1000));
			...
			for (int i = 0; i < 24; i++) {
				EZ.addText(EZgui.x / 16, i * (int) (((EZgui.y * .931) / 2 + y - (EZgui.y * 75 / 1000)) / 24)
						+ (int) (EZgui.y * 75 / 1000), i + ":00", Color.black, 18);
				EZ.addLine(EZgui.x / 8,
						i * (int) (((EZgui.y * .931) / 2 + y - (EZgui.y * 75 / 1000)) / 24)
								+ (int) (EZgui.y * 75 / 1000),
						EZgui.x, i * (int) (((EZgui.y * .931) / 2 + y - (EZgui.y * 75 / 1000)) / 24)
								+ (int) (EZgui.y * 75 / 1000),
						Color.black, 2);
			}
		}
